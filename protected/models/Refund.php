 ...
 */
class Refund extends HMSActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('applicant_id, allotment_id, amount, date, date_applied, create_user, create_time', 'required'),
			array('applicant_id, allotment_id, amount, create_user, update_user', 'length', 'max'=>10),
			array('update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, applicant_id, allotment_id, amount, date, date_applied, create_user, create_time, update_user, update_time', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'date' => 'Refund Date',
			'date_applied' => 'Applied for Refund on',
