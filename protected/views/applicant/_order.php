...
<div class="row" style="font-size: 11pt; line-height: 14pt;">
    ...
    <p>
        2.<span style="margin-left: 0.88in">Payment schedule for balance amount is as under: </span>
    <table style="font-size: 11pt; margin: 0 0 0 1in; width: 350px; line-height: 0px;">
        <thead>
...
<p class="text-justify">
    3.<span style="margin-left: 0.88in">A penalty of up to </span><?php echo $model->scheme->penalty; ?>%
...
<p class="text-justify">
    4.<span style="margin-left: 0.88in">Lucky</span> owners of corner plots shall pay an additional amount equal to 5% of the
    total cost of the plot along with last installment.
</p>
<p class="text-justify">
    5.<span style="margin-left: 0.88in">A</span> Collection Account No. <?php echo $model->scheme->account; ?> 
    has been opened with the <?php echo $model->scheme->bank; ?>. 
    Allottees may deposit payment direct into the said branch.
</p>
<p class="text-justify">
    6.<span style="margin-left: 0.88in">Allottees</span> who want to remit money 
...
<p class="text-justify">
    7.<span style="margin-left: 0.88in">The</span> Provincial Housing Authority 
